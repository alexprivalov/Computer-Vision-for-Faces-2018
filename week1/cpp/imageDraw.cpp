...
int main(void) {
    ...
    imwrite("results/imageLine.jpg", imageLine);
    ...
    imwrite("results/imageCircle.jpg", imageCircle);
    ...
    imwrite("results/imageEllipse.jpg", imageEllipse);
    ...
    imwrite("results/imageRectangle.jpg", imageRectangle);
    ...
    imwrite("results/imageText.jpg", imageText);
